...
# Parsing + Configuration Script – SOP - Rev. A

This **Parsing + Configuration** script is designed for the **SOP** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – SOP Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **SOP** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
